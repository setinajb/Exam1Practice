...
def problem2a(circle, rectangle, window):
    ...
    # draw circle and rectangle, continue on click
    ...
    # draw line in rect as arrow, continue on click
    start_point = rectangle.get_upper_right_corner()
    end_point = rectangle.get_lower_left_corner()
